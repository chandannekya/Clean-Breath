...
const ContactUs = () => {
  return (
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 py-16 px-4 font-sans transition-colors duration-300 dark:bg-gray-900 dark:text-gray-200">
      <div className="max-w-6xl mx-auto">
        <header className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-green-700 mb-4 tracking-tight dark:text-green-500">
            Get in Touch
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <section className="w-full lg:w-1/2">
            <h2 className="text-2xl font-semibold text-green-700 mb-6 dark:text-green-500">
              Contact Information
            </h2>
              ...
              {[
                ...
                <div
                  ...
                  className="flex items-start gap-4 p-6 rounded-xl bg-white 
                             ...
                             dark:bg-gray-800 dark:shadow-xl dark:border-green-700 dark:hover:border-green-500"
                >
          ...
          {/* Form Section */}
          <section className="w-full lg:w-1/2">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 transition-colors duration-300 dark:bg-gray-800 dark:shadow-xl dark:border-gray-700">
              <h2 className="text-2xl font-semibold text-green-700 mb-6 dark:text-green-500">
                Send Us a Message
              </h2>
              <form className="space-y-6">
                {[
                  ...
                  <div key={field.id} className="flex flex-col">
                    <label
                      htmlFor={field.id}
                      className="text-sm font-medium text-gray-700 mb-2 dark:text-gray-300"
                    >
                      {field.label}
                    </label>
                    <input
                      ...
                      className="p-3 bg-gray-50 border border-gray-200 rounded-lg 
                                 ...
                                 dark:placeholder-gray-400 dark:focus:ring-green-500 dark:hover:border-green-500"
                    />
                  </div>
                ))}
